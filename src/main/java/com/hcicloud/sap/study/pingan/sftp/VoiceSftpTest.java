package com.hcicloud.sap.study.pingan.sftp;
...
//                        JSONObject successJsonObject =  new JSONObject(array.getJSONObject(i));
                        ...
                        System.out.println("年: " + nowTime.get(Calendar.YEAR));
                        System.out.println("月: " + (nowTime.get(Calendar.MONTH) + 1));
                        System.out.println("日: " + nowTime.get(Calendar.DAY_OF_MONTH));
